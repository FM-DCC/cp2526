...
~\\[-12mm]
\begin{eqnarray*}
	B_{1f}&:= & b1rf!.B_{1f}+b1wf?.B_{1f}+b1wt?.B_{1t}\\[-1pt]
B_{1t}&:= & b1rt!.B_{1t}+b1wf?.B_{1f}+b1wt?.B_{1t}\\[-1pt]
	B_{2f}&:= & b2rf!.B_{2f}+b2wf?.B_{2f}+b2wt?.B_{2t}\\[-1pt]
B_{2t}&:= & b2rt!.B_{2t}+b2wf?.B_{2f}+b2wt?.B_{2t}\\[-1pt]
	K_{1}&:= & kr1!.K_{1}+kw1?.K_{1}+ kw2?.K_{2}\\[-1pt]
K_{2}&:= & kr2!.K_{2}+kw1?.K_{1}+ kw2?.K_{2}\\[-1pt]
