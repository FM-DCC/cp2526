...
\setLecture{7}{Short introduction to Scala}
% \frame[plain]{\titlepage}


\section{Module 2: programming with Java's memory model}


\begin{frame}{Module 2: programming with Java's memory model}
...
~~~~~~\alert{Online:} \url{https://scastie.scala-lang.org/auN6B4mVSiyfE0s7RZ37xQ}
\end{frame}
...
\begin{frame}[fragile]\frametitle{Pattern matching (in Scala 3)}
~\\[-8mm]
\begin{columns}
\begin{column}{0.56\textwidth}
\begin{lstlisting}
...
\end{column}
\begin{column}{0.42\textwidth}
\begin{lstlisting}[morekeywords={enum}]
enum IntOrError:
  case MyInt(i:Int)
