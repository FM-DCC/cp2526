...
\includegraphics[width=5cm]{src/img/nam/rm.jpg}\includegraphics[width=4cm]{src/img/nam/cc.png}1989
\end{frame}
...
\end{column}
\end{columns}
\only<3->{\centerline{\includegraphics[width=2cm]{src/img/nam/rec00lts}
...
\centerline{\includegraphics[width=8cm]{src/img/nam/rec0lts}}
