...
\only<3->{
\begin{eqnarray*}
P&::=& 0 \;\mid\; X[r_1,\ldots ,r_n] \;\mid \;P+P\;  \mid \; \alert{\alpha}.P\;\mid\; P | P \;\mid\; P\backslash H \\
\alert{\alpha}& ::=& \tau \mid a! \mid a? \mid a!v \mid a?v \mid a!x \mid a?x  \end{eqnarray*}
...
\begin{eqnarray*}
P&::=& 0 \;\mid\; X[r_1,\ldots ,r_n] \;\mid \;P+P\;  \mid \;\alpha.P\;\mid\; P | P \;\mid\; P\backslash H\mid\alert{ when(b) P}\\
