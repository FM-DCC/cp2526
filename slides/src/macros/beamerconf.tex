...
\newcommand{\setLectureBasic}[2][]{
  \title{
    #2
    }
  \author{Jos\'{e} Proen\c{c}a#1}
  \institute{CISTER -- U.Porto, Porto, Portugal
            \hfill 
            \begin{tabular}{r@{}}
            \url{https://fm-dcc.github.io/cp2526}
            \end{tabular}
            }
  \date{Concurrent programming (CC3040) 2025/2026}
  % logos of institutions
  \titlegraphic{
    \begin{textblock*}{5cm}(3.5cm,7.00cm)
    ...
    % \end{textblock*}
    \begin{textblock*}{5cm}(9.0cm,7.45cm)
      \includegraphics[scale=0.16]{src/img/logos/cister}
    \end{textblock*}
  }  
  \frame[plain]{\titlepage}
}
\newcommand{\setLecture}[3][]{\setcounter{lectureID}{#2}\setLectureBasic[#1]{#2. #3}}
...
\hypersetup{
    ...
    unicode,
    bookmarks,
    urlcolor= barcolor!75!black, %[rgb]{0,0,0.5}.
    linkcolor=barcolor!50!black
}
