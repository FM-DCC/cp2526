...
\\\bash{sbt> reload}
\note{If you want to use a more powerful IDE, you can use IntelliJ, start a new project from source files, and point to the \code{built.sbt} file. Nowadays VS Code also works very well.}
...
\end{lstlisting}
See the \href{https://docs.scala-lang.org/overviews/collections-2.13/iterators.html}{Iterator API} in the standard library documentation.
